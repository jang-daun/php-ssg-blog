    ...
    <div class="con flex">
        <div class="pg-left-box flex">
            ...
            <div class="pg-left-box__btn flex">
                <a href="pfpro/process.html" target="_blank" class="process-btn">
        ...
        <div class="pg-right-box flex">
            <div class="pg-right-box__cont">
                <img class="pf-personal-txt" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/pf-personal-txt.svg" alt=""> 
            </div>
        </div>
    </div>
</div>
