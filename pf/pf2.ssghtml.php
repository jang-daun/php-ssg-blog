    ...
    <div class="con flex">
        <div class="pg-left-box flex">
            ...
            <div class="pg-left-box__btn flex">
                <a href="greenpeace/process.html" target="_blank" class="process-btn">
                ...
                <a href="greenpeace/index.ssghtml.php" target="_blank" class="web-site-btn">
        ...
        <div class="pg-middle-box flex">
            <div class="pg-middle-box__line flex">
                <div class="pg-middle-box__img-box">
                    <img style="" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/pf-2-img.png" alt=""> 
                </div>
            </div>
        </div>
        <div class="pg-right-box flex">
            <div class="pg-right-box__cont">
                <img class="pf-renewal-txt" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/pf-renewal-txt.svg" alt=""> 
            </div>
        </div>
    </div>
</div>
