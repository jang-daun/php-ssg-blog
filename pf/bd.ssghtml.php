...
<div id="branding">
    <img class="img branding-page__bg" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/branding-bg.jpg" alt="">
    <img class="img branding-page__big-tt" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/branding-big-tt.svg"
        alt="">
    <img class="img branding-page__moon1" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/branding-title-moon1.svg"
        alt="">
    <img class="img branding-page__moon2" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/branding-title-moon2.svg"
        alt="">
    ...
    <a href="about.ssghtml.php">
        <img style="width:124.0056px" class="more-txt" src="https://cdn.jsdelivr.net/gh/jang-daun/portfolio/footer-more-about.svg"
        alt="">
    </a>
