            ...
            <div class="behavior__bord flex">
                <div class="behavior__box flex">
                    <div class="behavior__box__box">
                        <img class="icon"
                            src="https://cdn.jsdelivr.net/gh/jang-daun/web-resource/green/img/behavior__solution.svg"
                            alt="">
                        <a href="#">해결책 제시</a>
                ...
                <div class="behavior__box flex">
                    <div class="behavior__box__box">
                        <img class="icon"
                            src="https://cdn.jsdelivr.net/gh/jang-daun/web-resource/green/img/behavior__peace-1.svg"
                            alt="">
                        <a href="#">비폭력 직접행동</a>
                ...
                <div class="behavior__box flex">
                    <div class="behavior__box__box">
                        <img class="icon"
                            src="https://cdn.jsdelivr.net/gh/jang-daun/web-resource/green/img/behavior__global.svg"
                            alt="">
                        <a href="#">글로벌 영향력</a>
                ...
                <div class="behavior__box flex">
                    <div class="behavior__box__box">
                        <img class="icon"
                            src="https://cdn.jsdelivr.net/gh/jang-daun/web-resource/green/img/behavior__money.svg"
                            alt="">
                        <a href="#">재정적 독립성</a>
...
<div id="main-content-4">
    <div class="main-content-4-back"></div>
    <div class="con flex">
...
<div id="main-content-6" class="">
    <div class="con flex">
        ...
        <div class="campaign__content partici__content flex">
            <div class="partici-box flex">
                <div class="partici-box-box flex">
                    <div class="partici-box-in partici-box-in-green flex">
                        <a href="#">서명으로 동참해주세요</a>
                        <a href="#">
                            여러분의 관심이 더 나은 미래를 만들 수 있습니다.
                        </a>
                        <span><a href="#">서명 하기</a></span>
                    </div>
                </div>
                <div class="partici-box-box flex">
                    <div class="partici-box-in partici-box-in-blue flex">
                        <a href="#">자원활동가에 함께 해주세요</a>
                        <a href="#">
                            그린피스는의 긍정적인 변화를 만들어 갈 자원활동가를 모집합니다.
                        </a>
                        <span><a href="#">함께 하기</a></span>
                    </div>
                </div>
            </div>
            <div class="partici-box">
                <div class="partici-box-box-2 flex">
                    <div class="partici-box-in partici-box-in-donate flex">
                        <a href="#">후원으로 변화를 만드세요</a>
                        <a href="#">
                        여러분의 후원으로 주요 환경문제에 맞설 수 있습니다.
                        </a>
                        <span><a href="#">후원 하기</a></span>
                    </div>
                </div>
            </div>
        </div>
