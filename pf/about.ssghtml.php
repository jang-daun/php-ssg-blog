...
<div id="about">
    <img class="about-page-bg" src="https://cdn.jsdelivr.net/gh/jang-daun/phpblog/img/about-bg.jpg" alt="">
    <div class="con">
    ...
    <a href="pf.ssghtml.php">
        <img style="width:123.6975px" class="more-txt" src="https://cdn.jsdelivr.net/gh/jang-daun/portfolio/footer-more-work.svg"
        alt="">
    </a>
